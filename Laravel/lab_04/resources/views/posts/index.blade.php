...
@section('content')
    <div class="container mx-auto">
        ...
        @can('is-admin')
            <div class="mx-4">
                <a href="{{ route('admin.dashboard') }}" class="bg-purple-600 px-4 py-2 my-5 border-2 border-black block text-center">
                    Admin Dashboard
                </a>
            </div>
        @endcan
        ...
        <div class="my-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
                ...
                class="block border-2 border-black bg-white p-4 shadow-[4px_4px_0_0] hover:bg-yellow-100 focus:ring-2 focus:ring-yellow-300 focus:outline-0 sm:p-6">
                    ...
                    @if ($post->image)
                        <img src="{{ asset('storage/' . $post->image) }}" alt="Post image" class="w-full h-40 object-cover mb-3 border-2 border-black">
                    @endif
